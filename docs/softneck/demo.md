...
![yarpmanager](../fig/yarpmanager.png)
...
9. Turn on the Space Navigator (A blue LED will start flashing) and launch streamingDeviceController.
10. Launch yarpscope for visualizing the inputs for the three motors through the following command:
    ```bash
